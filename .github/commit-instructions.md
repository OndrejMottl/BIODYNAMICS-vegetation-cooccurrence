...
Use exactly this plain-text pattern on a single line:

<subject>: <short summary>

Return only the commit message line. Do not wrap it in code fences, backticks, quotes, bullets, labels, or any extra explanation.
...
Do not use: *enhance*, *feat*, *feature*, *fix* (use a specific verb instead, e.g. *correct*, *remove*, *add*, *update*, *switch*, *adjust*, *replace*).
