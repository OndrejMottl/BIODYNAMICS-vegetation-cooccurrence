...
<table style="width: 100%;"><tr><td>load_auxiliary_classification_table</td><td style="text-align: right;">R Documentation</td></tr></table>

<h2>Load an auxiliary classification table</h2>
...
<pre><code class='language-R'>load_auxiliary_classification_table(
...
<tr><td><code id="file_auxiliary_classification_table">file_auxiliary_classification_table</code></td>
<td>
...
optional — any that are absent are filled with 'NA_character_'.</p>
</td></tr>
</table>
...
<p>[build_combined_classification_table()],
