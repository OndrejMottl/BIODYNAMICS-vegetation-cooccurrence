...
<td>
<p>A character vector of column name(s) to group by when nesting data for
interpolation (default: &quot;dataset_name&quot;).</p>
</td></tr>
...
<td>
<p>Name of the value variable column (default: &quot;value&quot;).</p>
</td></tr>
...
<td>
<p>Number of cores to use for interpolation. Use '1' for sequential
'purrr::map()' execution, or a value greater than '1' for parallel
'furrr::future_map()' execution.</p>
</td></tr>
<tr><td><code id="verbose">verbose</code></td>
<td>
<p>Logical. If 'TRUE' (default), progress bars are displayed where supported.</p>
</td></tr>
</table>
...
<p>Nests data by dataset and taxon. It interpolates with 'stats::approx()'
