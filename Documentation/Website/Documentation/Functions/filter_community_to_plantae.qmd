---
format: html
title: filter_community_to_plantae()
---
...
<table style="width: 100%;"><tr><td>filter_community_to_plantae</td><td style="text-align: right;">R Documentation</td></tr></table>

<h2>Filter Community to Plantae</h2>

<h3>Description</h3>

<p>Removes taxa that do not belong to the kingdom Plantae from a
...
<pre><code class='language-R'>filter_community_to_plantae(
  data_community,
...
<td>
<p>A data frame containing community data with at minimum a column
named 'taxon'.</p>
</td></tr>
<tr><td><code id="data_classification_table">data_classification_table</code></td>
<td>
<p>A data frame with columns 'sel_name' and 'kingdom', mapping
taxon names to their kingdom classification.</p>
</td></tr>
<tr><td><code id="verbose">verbose</code></td>
<td>
<p>Logical scalar. If 'TRUE', warn when non-Plantae or unclassified
taxa are removed.</p>
</td></tr>
</table>
...
<p>Performs a left join between 'data_community' and
'data_classification_table'
...
<p>A data frame identical in structure to 'data_community' but with all rows
