...
<table style="width: 100%;"><tr><td>load_chelsa_raster</td><td style="text-align: right;">R Documentation</td></tr></table>

<h2>Load and Cache a CHELSA-TraCE21k Raster</h2>

<h3>Description</h3>

<p>Loads a cropped CHELSA-TraCE21k raster for a given
...
<pre><code class='language-R'>load_chelsa_raster(
...
<tr><td><code id="abiotic_variable_name">abiotic_variable_name</code></td>
<td>
...
<tr><td><code id="dir_cache">dir_cache</code></td>
<td>
<p>Character scalar. Path to the directory where the cropped
raster is cached as
'abiotic_variable_name_age_xmin_xmax_ymin_ymax.tif'.
