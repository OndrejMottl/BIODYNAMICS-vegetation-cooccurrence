...
<table style="width: 100%;"><tr><td>compute_spatiotemporal_mev</td><td style="text-align: right;">R Documentation</td></tr></table>

<h2>Compute Spatiotemporal Moran Eigenvector Maps</h2>

<h3>Description</h3>

<p>Computes Moran Eigenvector Maps (MEMs) from a 3-D
...
<pre><code class='language-R'>compute_spatiotemporal_mev(
...
<td>
<p>A data frame with columns 'dataset_name' and 'age'
giving the valid (site × time-slice) pairs to model,
as returned by 'align_sample_ids()'.</p>
</td></tr>
...
message is emitted. Default is '20L'.</p>
</td></tr>
</table>
...
<p>Unlike 'compute_spatial_mev()', which operates on
...
<p>The 3-D coordinate matrix is constructed as follows:
...
<p>The z-scoring step is critical: if age is left in
...
<p>Because the eigenvectors are computed at the sample
...
<p>A data frame with row names '&quot;&lt;dataset_name&gt;__&lt;age&gt;&quot;'
and 'n_mev' columns named 'mev_1', 'mev_2', …,
'mev_n_mev'. The row order follows
