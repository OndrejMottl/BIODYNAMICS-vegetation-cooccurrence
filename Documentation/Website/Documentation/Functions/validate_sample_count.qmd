...
<table style="width: 100%;"><tr><td>validate_sample_count</td><td style="text-align: right;">R Documentation</td></tr></table>

<h2>Validate Sample Count</h2>
...
<pre><code class='language-R'>validate_sample_count(data_sample_ids = NULL, minimum_sample_count = 1)
</code></pre>
