...
<table style="width: 100%;"><tr><td>diagnose_jsdm_convergence</td><td style="text-align: right;">R Documentation</td></tr></table>

<h2>Diagnose sjSDM Model Convergence</h2>

<h3>Description</h3>

<p>Assesses whether a fitted sjSDM model has converged by analysing
...
<pre><code class='language-R'>diagnose_jsdm_convergence(mod_jsdm = NULL)
</code></pre>
...
<td>
<p>A fitted sjSDM model object. Must be of class 'sjSDM'.</p>
</td></tr>
</table>
...
<p>The function uses the 'history' component of the fitted sjSDM
model, which stores the per-epoch negative log-likelihood values
produced during gradient descent.
</p>
<p>sjSDM pre-allocates 'history' to the full epoch budget. When
...
<p>Two diagnostic metrics are computed on the tail (final 10
epochs actually run):
</p>
<p>1. **Linear trend slope** — A near-zero slope means the loss is
...
<p>[fit_jsdm_model()], [evaluate_jsdm()]
</p>
