# Co-Author Feedback — Round TODO

**Manuscript version:** `Documentation/Manuscript/Coauthor_feedback/Round_N/manuscript_round_N.pdf`  
**Git tag:** `manuscript-round-N`  
**Date shared:** YYYY-MM-DD  
**Deadline for feedback:** YYYY-MM-DD  
...
| # | Line(s) | Section | Type | Comment | Suggested change (optional) |
|---|---------|---------|------|---------|----------------------------|
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
...
*(Add more rows as needed by copying a row and incrementing the #)*
