...
- Include all historical outliers whose final settings have `n_iter > 6400`, `n_sampling > 1000`, or disabled early stopping, plus all three paleo temporal continental profiles.
- Run eight candidates on all five folds of repeat one across iteration rungs `500, 1000, 2000, 4000, 8000, 16000, 32000, 64000` with sampling `200` until acceptance is possible.
