...
<!-- slide:02 -->
## Is there a [scale dependence]{.text-color-spatial .text-bold} in the amount of unexplained variation ([potentially due to biotic interactions]{.text-color-latent}) structuring vegetation? {.slide-terminal .slide-terminal-question}
...
::: {.oracle-line}
 - [spatial structure]{.oracle-highlight .oracle-highlight-spatial}
:::

::: {.oracle-line}
 - [climate response]{.oracle-highlight .oracle-highlight-abiotic}
:::

::: {.oracle-line}
 - [residual species-species association]{.oracle-highlight .oracle-highlight-latent}.
:::
:::
...
::: {.oracle-line}
 - [Spatial-resolution runs]{.oracle-highlight .oracle-highlight-spatial} : chnages with spatial scale
:::

::: {.oracle-line}
 - [Temporal slices test]{.oracle-highlight .oracle-highlight-abiotic} : change through time.
:::

::: {.oracle-line}
- [Taxonomic aggregation level]{.oracle-highlight .oracle-highlight-latent} : change through classification.
:::
:::
...
::: {.oracle-line}
[Abiotic predictors]{.oracle-highlight .oracle-highlight-abiotic} explain shared response.
:::
...
::: {.oracle-line}
[Caution]{.oracle-highlight .oracle-highlight-warning .text-color-warning}: co-occurrence is not proof of [interaction]{.oracle-highlight .oracle-highlight-warning}.
:::
