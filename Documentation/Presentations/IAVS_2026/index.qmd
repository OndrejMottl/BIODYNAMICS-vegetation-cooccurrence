...
::: {.oracle-line}
 - Age uncertainty [propagated]{.text-emphasis-underline-dotted} to estimate counts
:::
...
<!-- slide:10 -->
## [Is the [association signal]{.text-color-latent} stable through [time]{.text-emphasis-underline}?]{.fragment .fragment-terminal data-fragment-index="0"} {.slide-terminal .slide-terminal-question}
...
::: {.oracle-line}
[Temporal mode]{.text-emphasis-underline} selected: Slicing the data into [500-year windows]{.text-emphasis-chip}
:::
...
::: {.oracle-line}
Plotting temporal trajectories for each [continent]{.text-emphasis-underline-dotted}
:::
:::
...
::: {.oracle-line}
Summarising RESULTS together: [spatial]{.text-color-spatial} patterns, [taxonomic]{.text-color-latent} resolution, [temporal]{.text-emphasis-underline} dynamics
:::
...
[TIME]{.text-emphasis-underline}<br>
...
::: {.oracle-line}
Current [SDM]{.text-emphasis-chip} models can be used to [futher predict]{.text-emphasis-caps .text-emphasis-underline-thick} the biodiversity patterns under the [future climate change]{.text-emphasis-underline-dotted} scenarios
:::
:::
