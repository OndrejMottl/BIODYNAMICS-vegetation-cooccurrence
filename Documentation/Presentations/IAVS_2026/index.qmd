...
<!-- slide:01 -->
## ... booting {.slide-terminal .slide-terminal-story}
...
<!-- slide:02 -->
## Is there a [scale dependence]{.text-bold .text-emphasis-underline} in the amount of unexplained variation (potentially due to [biotic interactions]{.text-color-latent}) structuring vegetation? {.slide-terminal .slide-terminal-question}
