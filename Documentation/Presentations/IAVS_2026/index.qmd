...
Palaecological data can be used to [reconstruct]{.text-emphasis-underline} [past]{.text-emphasis-underline-dotted} [biodiversity]{.text-color-purple} patterns and bring insights into our understanding of ecological processes.
:::
::: {.fragment data-fragment-index="3" .text-emphasis-box}
[SPACE]{.text-highlight-spatial}: 
The association signal is [NOT]{.text-emphasis-underline} scale-dependent and [NOT]{.text-emphasis-underline} stronger at [local]{.text-emphasis-underline-dotted} than at [continental]{.text-emphasis-underline-dotted} scales
:::

::: {.fragment data-fragment-index="4" .text-emphasis-box}

[TAXONOMY]{.text-highlight-latent}: 
Increasing [taxonomic resolution]{.text-emphasis-underline-dotted} [does have]{.text-emphasis-underline} impact on [spatial pattern]{.text-color-spatial} of the association signal, but [NOT]{.text-emphasis-underline} in the [expected direction]{.text-emphasis-underline-dotted} 

:::

::: {.fragment data-fragment-index="5" .text-emphasis-box}
[TIME]{.text-highlight-temporal}: 
Co-occurrence structure [are]{.text-emphasis-underline} responding to major environmental changes through time, but the [association signal]{.text-emphasis-underline-dotted} [is]{.text-emphasis-underline} surpraisingly [stable]{.text-emphasis-underline-dotted} through time.
:::

::: {.fragment data-fragment-index="6" .text-emphasis-box}
Palaeocological data can be used to [predict]{.text-emphasis-underline} [future]{.text-emphasis-underline-dotted} [biodiversity]{.text-color-purple} patterns and support conservation efforts.
:::
