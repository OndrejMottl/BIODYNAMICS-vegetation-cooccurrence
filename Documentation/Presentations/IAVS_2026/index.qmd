...
::: {.column width="20%"}
![This will be fliped 90 degrees and blend with background](figures/story/genai_drafts/planet_abstract_scan_motif_v3.png){.image-display-block .margin-x-auto .image-height-story .image-blend-screen .image-fit-contain .width-full .image-glow}
:::
...
:::: {.columns}
::: {.column width="58%" .fragment .tui-reveal}
![This needs to be much larger and blended with background](figures/story/genai_drafts/oracle_abstract_face_motif_v3.png){.image-display-block .margin-x-auto .image-height-story .image-blend-screen .image-fit-contain .width-full}
:::
...
<!-- slide:02 -->
## Does unexplained structure change with scale? {.slide-terminal .slide-terminal-question}

:::: {.columns}
::: {.column width="65%"}
![Conceptual narrative visual: three ORACLE input streams for climate, space, and association.](figures/story/genai_drafts/query_three_streams_motif_v6.png){.image-display-block .margin-x-auto .image-height-story .image-blend-screen .image-fit-contain .width-full}
:::
...
- [taxonomic resolution]{.text-color-purple}
