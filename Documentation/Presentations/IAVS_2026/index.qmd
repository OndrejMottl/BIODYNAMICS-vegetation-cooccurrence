...
<!-- Spatial models, species-species association variance x model R2 -->

## Is there relationship between species-species association and network modularity? {.slide-terminal .slide-terminal-results}

<!-- Temporal models, species-species association variance x network modularity -->
...
<!-- Temporal models, network modularity x network size -->
