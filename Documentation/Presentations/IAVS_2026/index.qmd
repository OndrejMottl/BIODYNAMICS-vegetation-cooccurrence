...
![](figures/story/genai_drafts/query_three_streams_motif_v6.png){.image-display-block .margin-x-auto .image-blend-screen .image-fit-contain .width-full}
:::
...
<!-- slide:03 -->
## Archive: [&lt;VegVault&gt;]{.text-color-cyan} {.slide-terminal .slide-terminal-story}

:::: {.columns}
::: {.column width="62%"  .fragment .tui-reveal data-fragment-index="2"}
...
::: {.column width="38%" }
::: {.oracle-says .terminal-cursor .fragment .tui-reveal data-fragment-index="1"}
...
::: {.fragment .tui-reveal data-fragment-index="3"}
--VegVault logo--
...
![](figures/story/genai_drafts/analysis_axes_triptych_motif_v2_crop.png){.image-display-block .margin-x-auto .image-height-story .image-blend-screen .image-fit-contain .width-full}
:::
:::
...
::: {.column width="60%" .fragment .tui-reveal data-fragment-index="2"}
...
::: {.column width="50%" .fragment .tui-reveal data-fragment-index="2"} 
...
::: {.oracle-line}
Network diagnostics loaded. Co-occurrence structure can change
:::

::: {.oracle-line}
even when variance components look similar.
:::
...
::: {.oracle-line}
Association-like structure can persist
:::

::: {.oracle-line}
after the most obvious environmental
:::

::: {.oracle-line}
and spatial patterns are accounted
:::
