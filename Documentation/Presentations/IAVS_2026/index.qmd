...
## BIODYNAMICS: ECOLOGICAL BIOSURVEILLANCE SYSTEM {.slide-title}
...
[talking to &lt;ORACLE&gt;:]{.text-title-heading .text-size-heading-small}

[Exploring biotic signals in vegetation assembly from the LGM to the Anthropocene]{.text-title-heading .text-size-heading-large}

<br>

[Ondrej Mottl]{.text-size-body-large .text-color-purple .text-bold }

[IAVS 2026 || 22-26 June 2026 || Gijón, Spain]{.text-size-body .text-color-amber}
...
::: {.column width="33%"}
::: {.terminal-status .text-position-center}
...
<!-- slide:17 -->
## Vegetation co-occurrence across scale {.slide-title}
