...
::: {.column width="65%" .fragment .tui-reveal-blur data-fragment-index="2"}
...
::: {.text-equation .text-size-body-large}

[$Y_{ij} \sim \operatorname{Bernoulli}\{\Phi(\eta_{ij})\}$]{.text-equation-line}
...
::: {.text-equation-meta .text-size-body}
