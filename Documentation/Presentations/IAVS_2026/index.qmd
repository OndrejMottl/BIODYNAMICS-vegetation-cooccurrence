...
<!-- slide:02 -->
## [Is there a [scale dependence]{.text-bold .text-emphasis-underline} in the amount of unexplained variation (potentially due to [biotic interactions]{.text-color-latent}) structuring vegetation?]{.fragment .fragment-terminal data-fragment-index="0"} {.slide-terminal .slide-terminal-question}
...
::: {.oracle-line}
residual [species-species association]{.text-highlight-latent}.
:::
:::
...
<!-- slide:03 -->
## DATA: [&lt;VegVault&gt;]{.text-emphasis-chip} {.slide-terminal .slide-terminal-methods}
...
<!-- slide:05 -->
## Preparing [community]{.text-color-latent} and [climate]{.text-color-abiotic} streams {.slide-terminal .slide-terminal-methods}
...
::: {.oracle-line}
[Data extracted, now preparation ...]{.text-emphasis-chip}
:::
