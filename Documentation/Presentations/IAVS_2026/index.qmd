...
```{r}
#| label: result-slide05-climate-render
#| echo: false
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/IAVS_2026/figures/results/panels/slide_05_climate_screening.png"
  )
)
```
