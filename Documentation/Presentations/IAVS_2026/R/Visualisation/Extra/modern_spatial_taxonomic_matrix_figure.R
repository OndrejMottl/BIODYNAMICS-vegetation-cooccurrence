...
#
#       Extra slide modern spatial taxonomic figure
#
#----------------------------------------------------------#
...
#----------------------------------------------------------#
# 1. Load contemporary spatial results -----
#----------------------------------------------------------#
...
figure_modern_spatial_taxonomic_matrix <-
  cowplot::plot_grid(
    plot_association_spread_no_legend,
    cowplot::plot_grid(
      plot_triangle_legend,
...
ggview::save_ggplot(
  plot = figure_modern_spatial_taxonomic_matrix,
  file = base::file.path(
    path_output,
    "slide_extra_01_modern_spatial_taxonomic_matrix.png"
  ),
  device = ragg::agg_png
)
