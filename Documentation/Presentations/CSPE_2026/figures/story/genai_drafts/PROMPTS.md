...
This file records the exact prompts used to generate draft GenAI story assets for the CSPE 2026 ORACLE presentation. The canonical committed story assets are still generated by `R/generate_story_figures.R` unless this register is updated.
...
```text
Use case: stylized-concept
Asset type: GenAI draft for CSPE 2026 MOTHER companion screen, rough CRT terminal style
...
```text
Use case: stylized-concept
Asset type: GenAI draft for CSPE 2026 opening planet screen, rough CRT terminal style
...
```text
Use case: stylized-concept
Asset type: GenAI draft for CSPE 2026 MOTHER companion, abstract non-human version
...
```text
Use case: stylized-concept
Asset type: GenAI draft for CSPE 2026 atmospheric biosphere, abstract terminal version
...
```text
Use case: stylized-concept
Asset type: GenAI draft for CSPE 2026 story/premise slide, inspired by slide 02 of the May 11 terminal reference sheet
...
```text
Use case: stylized-concept
Asset type: CSPE 2026 ORACLE presentation story asset for Slide 02 query composition, 16:9 landscape
...
```text
Use case: stylized-concept
Asset type: CSPE 2026 ORACLE presentation story asset for Slide 04 analysis-axes composition, 16:9 landscape
...
```text
Use case: stylized-concept
Asset type: CSPE 2026 ORACLE presentation story asset for Slide 14 closing-terminal transition, 16:9 landscape
...
```text
Use case: stylized-concept
Asset type: CSPE 2026 ORACLE presentation story asset for Slide 04 analysis-axes overview, 16:9 landscape.
...
```text
Use case: stylized-concept
Asset type: CSPE 2026 ORACLE presentation story asset for Slide 14 cinematic terminal-closing transition, 16:9 landscape.
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, portrait blend-in planet motif for title slide compositing.
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, portrait blend-in planet scan motif revision
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, centered ORACLE face crop revision
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, standalone spatial query stream panel
...
```text
Use case: stylized-concept
Asset type: 1600 x 900 RevealJS slide story figure for the CSPE 2026 ORACLE terminal presentation
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, standalone spatial analysis-axis panel
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, standalone temporal analysis-axis panel
...
Final asset was cropped and resized non-destructively to `480 x 400 px` after generation. The committed `analysis_axes_triptych_motif_v2_temporal_v1.png` was later deterministically recolored from amber to phosphor `#B8FF6D` to match the temporal semantic rule in `VISUAL_GUIDE.md`.

## Prompt 30: Standalone Taxonomic Analysis Axis

```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, standalone taxonomic analysis-axis panel
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, standalone abiotic query stream panel
...
```text
Use case: precise-object-edit
Asset type: CSPE 2026 ORACLE presentation story asset, standalone latent association query stream panel
