...
#
#          Render CSPE 2026 presentation
#
#                   O. Mottl
#                    2026
#
#----------------------------------------------------------#
# Render the CSPE 2026 RevealJS presentation.
#   This script renders the standalone presentation artifacts in _output/.
#   The full website shell publishes that directory separately through
#   R/03_Supplementary_analyses/Documentation/Render_website.R.


here::i_am("Documentation/Presentations/CSPE_2026/R/render.R")


path_presentation <-
  here::here("Documentation/Presentations/CSPE_2026")

path_presentation_source <-
  base::file.path(path_presentation, "index.qmd")

path_presentation_output <-
  base::file.path(path_presentation, "_output")
