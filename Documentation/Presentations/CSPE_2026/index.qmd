...
#| label: setup
#| include: false
here::i_am("Documentation/Presentations/CSPE_2026/index.qmd")
...
number_of_cores <-
  format_count(
    list_results_snapshot[["summary_counts"]][["cores"]]
  )

number_of_samples <-
  format_count(
    list_results_snapshot[["summary_counts"]][["communities"]]
  )

number_of_taxa <-
  format_count(
    list_results_snapshot[["summary_counts"]][["taxa"]]
  )

number_trait_values <-
  format_count(
    list_results_snapshot[["summary_counts"]][["trait_values"]]
  )

number_of_functional_types <-
  format_count(
    list_results_snapshot[["summary_counts"]][["functional_types"]]
  )

number_of_models <-
  format_count(
    list_results_snapshot[["summary_counts"]][["models"]]
  )
...
[CSPE 2026 || 9 September 2026 || Prague, Czechia]{.text-size-title-small .text-color-amber}
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/Data_ingestion_schematic_figure.R"
  )
)

source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/northern_hemisphere_coverage_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_03_ingestion_schematic.png"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_03_northern_hemisphere_coverage.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/climate_data_summary_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_05_climate_screening.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/variance_decomposition_triangle_figure.R"
  )
)

source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/variance_decomposition_example_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_06_variance_decomposition.png"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_06_component_stack_example.png"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_06_component_point_example.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/spatial_units_map_figure.R"
  )
)

source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/spatial_association_tiles_figure.R"
  )
)
```
...
```
<!-- Internal provenance note: the displayed figures and synthesis counts use the frozen pre-rerun snapshot. The added-CV and corrected-trait rerun is still in progress. See RESULTS_PROVENANCE.md. Do not display this note on slides. -->
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_08_spatial_tiles.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/spatial_taxonomic_matrix_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_09_spatial_taxonomic_matrix.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/temporal_density_summary_figure.R"
  )
)

source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/network_diagnostic_pipeline_figure.R"
  )
)

source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/temporal_model_pipeline_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_10_temporal_density.png"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_10_temporal_pipeline.png"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_10_network_example.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/temporal_trajectory_animation_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/slide_11_temporal_trajectory_legend.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/future_predictions_animation.R"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/synthesis_summary_panel_figure.R"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/Extra/modern_spatial_taxonomic_matrix_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/extra/slide_extra_01_modern_spatial_taxonomic_matrix.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/Extra/spatial_association_model_quality_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/extra/slide_extra_02_spatial_association_model_quality.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/Extra/temporal_association_modularity_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/extra/slide_extra_02_temporal_association_modularity.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/Extra/temporal_network_size_modularity_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/extra/slide_extra_03_temporal_network_size_modularity.png"
  )
)
```
...
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/Extra/spatial_climate_parameters_auc_figure.R"
  )
)
```
...
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/extra/slide_extra_04_spatial_climate_parameters_auc.png"
  )
)
```
...
```{r}
#| label: extra-slide05-functional-type-nmds-generate
#| eval: false
#| include: false
#| cache: true
source(
  here::here(
    "Documentation/Presentations/CSPE_2026/R/Visualisation/Extra/functional_type_nmds_figure.R"
  )
)
```

```{r}
#| label: extra-slide05-functional-type-nmds-render
#| echo: false
#| out-width: 100%
knitr::include_graphics(
  here::here(
    "Documentation/Presentations/CSPE_2026/figures/results/extra/slide_extra_05_functional_type_nmds.png"
  )
)
```
