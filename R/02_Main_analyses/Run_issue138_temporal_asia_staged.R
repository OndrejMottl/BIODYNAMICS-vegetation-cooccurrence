# Run the issue 138 staged Asia temporal-slice validation.
...
run_issue138_representative_validation(
  active_config = "project_paleo_temporal_issue138_asia_staged",
  unit_pipeline = "R/Pipelines/pipeline_paleo_temporal.R",
  tuning_target_names = "data_sjsdm_tuning_summary_timeslice_6500",
