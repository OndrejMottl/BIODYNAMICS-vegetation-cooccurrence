...
# Workflow contract:
#   Requires the dated paleo unit table produced by spatial synthesis.
...
#   Each tile represents one unit-level Associations estimate, arranged by
#   spatial tier and taxonomic resolution, and the PDF is replaced on rerun.
