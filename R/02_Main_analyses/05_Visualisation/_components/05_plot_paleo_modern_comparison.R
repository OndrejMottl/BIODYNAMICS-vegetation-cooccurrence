...
# Workflow contract:
#   Requires the dated matched-unit table from paleo-modern synthesis.
#   The latest filename date is selected automatically; confirm its provenance
#   and matched-unit coverage before interpreting differences.
#   No target stores are read and no matching is performed in this script;
#   it only visualizes the already matched comparison table.
