...
# Requires completed temporal model fitting from stage 03.
# Workflow contract:
#   By default, reads every available continental temporal store and never
#   launches fitting. Missing continent stores are skipped, but no-store input
#   is fatal; verify all three expected continents before publication.
#   Both fixed output PDFs are replaced on rerun.
