...
#   data_coords targets.
# Workflow contract:
#   Run after accepted paleo stores exist for every intended tier and unit.
#   This script reads stores directly; it does not run pipelines or alter
#   target metadata. Missing model results remain visible as grey panels.
#   Verify expected store coverage before treating grey as biological absence.
#   Saves one fixed-layout PDF for each continent under Outputs/Figures/.
...
#----------------------------------------------------------#
# 8. Assemble and save continent figures (3 x 3 grid) -----
#----------------------------------------------------------#
