...
# Workflow contract:
#   Run after both paleo and modern synthesis inputs have been rebuilt from
#   accepted production stores. Target stores are read-only here.
#   Comparisons use an inner join on tier, unit, resolution, and component;
#   unmatched units are excluded and must be reviewed in the coverage table.
#   Writes dated matched-unit, summary, and compatibility CSV outputs.
