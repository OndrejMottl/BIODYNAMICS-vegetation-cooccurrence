...
# Workflow contract:
#   Run after all three modern spatial tiers complete in normal mode.
#   Reads available genus, family, and ft_modern results without changing
#   target stores. An entirely empty result is fatal, but this script does
#   not itself prove that every expected unit is present.
#   Writes dated unit and grouped summary CSV tables to Outputs/Tables/.
