...
#
#           Prepare modern spatial continental folds
#
#                       O. Mottl
#                         2026
#
#----------------------------------------------------------#
# Workflow contract:
#   Publishes current modern functional-type classifications and caches
#   continental prepared CV folds without fitting any model.
