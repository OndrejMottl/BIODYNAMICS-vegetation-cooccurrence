...
#
#              Prepare paleo spatial regional folds
#
#                       O. Mottl
#                         2026
#
#----------------------------------------------------------#
# Workflow contract:
#   Requires current paleo continental functional-type classifications.
#   Caches regional prepared CV folds without tuning or model fitting.
