...
#
#    Run paleo local predictive decomposition on GPU
#
#                       O. Mottl
#                         2026
#
#----------------------------------------------------------#
# Standalone runner for the matched-fold scientific decomposition reference.
...
#----------------------------------------------------------#
# 1. Paleo local predictive decomposition -----
#----------------------------------------------------------#
