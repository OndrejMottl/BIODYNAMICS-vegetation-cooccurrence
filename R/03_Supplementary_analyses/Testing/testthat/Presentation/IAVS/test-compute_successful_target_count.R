testthat::test_that(
  "compute_successful_target_count() counts successful pattern matches",
  {
    data_meta <-
      tibble::tibble(
    ...
    res <-
      compute_successful_target_count(
...
testthat::test_that(
  "compute_successful_target_count() returns zero when no matches succeed",
  {
    data_meta <-
      tibble::tibble(
...
testthat::test_that(
  "compute_successful_target_count() validates metadata columns",
  {
    data_meta <-
      tibble::tibble(
        target = "x"
