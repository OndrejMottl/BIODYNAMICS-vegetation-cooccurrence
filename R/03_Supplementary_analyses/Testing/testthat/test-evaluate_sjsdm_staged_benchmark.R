...
testthat::test_that(
  "evaluate_sjsdm_staged_benchmark() passes the frozen gates",
  {
    list_fixture <-
...
testthat::test_that(
  "evaluate_sjsdm_staged_benchmark() uses the frozen policy by default",
  {
    list_fixture <-
      make_sjsdm_staged_benchmark_fixture()
...
testthat::test_that(
  "evaluate_sjsdm_staged_benchmark() reports failed resource gates",
  {
    list_fixture <-
      make_sjsdm_staged_benchmark_fixture()
    data_failed <-
...
testthat::test_that(
  "evaluate_sjsdm_staged_benchmark() flags changed selection for review",
  {
    list_fixture <-
      make_sjsdm_staged_benchmark_fixture(
...
testthat::test_that(
  "evaluate_sjsdm_staged_benchmark() rejects incomplete pairs",
  {
    list_fixture <-
      make_sjsdm_staged_benchmark_fixture()
    data_incomplete <-
