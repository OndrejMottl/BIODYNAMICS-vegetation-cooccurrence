testthat::test_that(
  "resolve_latest_dated_file_path() returns latest dated file",
  {
    withr::with_tempdir(
      {
        file_old <-
...
testthat::test_that(
  "resolve_latest_dated_file_path() treats file_name_base literally",
  {
    withr::with_tempdir(
      {
        file_literal <-
...
testthat::test_that(
  "resolve_latest_dated_file_path() validates arguments",
  {
...
testthat::test_that(
  "resolve_latest_dated_file_path() errors when no file matches",
  {
    withr::with_tempdir(
      {
        testthat::expect_error(
