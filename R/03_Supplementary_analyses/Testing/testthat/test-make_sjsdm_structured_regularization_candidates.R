testthat::test_that(
  "make_sjsdm_structured_regularization_candidates() builds 16 rows",
  {
    vec_lambda_values <-
...
testthat::test_that(
  "make_sjsdm_structured_regularization_candidates() validates ranges",
  {
    ...
    testthat::expect_error(
      make_sjsdm_structured_regularization_candidates(alpha_cov = 1.1),
      "alpha_cov"
    )
  }
)
