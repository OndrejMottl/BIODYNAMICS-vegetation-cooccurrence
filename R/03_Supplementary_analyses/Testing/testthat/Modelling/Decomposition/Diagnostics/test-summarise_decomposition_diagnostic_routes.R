testthat::test_that(
  "summarise_decomposition_diagnostic_routes() groups shares by route",
  {
    data_metrics <-
      tibble::tibble(
...
testthat::test_that(
  "summarise_decomposition_diagnostic_routes() excludes failed variants",
  {
    data_metrics <-
      tibble::tibble(
        route_id = "route_a",
