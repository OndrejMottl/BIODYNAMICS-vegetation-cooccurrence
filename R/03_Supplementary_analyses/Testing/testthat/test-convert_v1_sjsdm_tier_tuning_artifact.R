testthat::test_that(
  "convert_v1_sjsdm_tier_tuning_artifact() upgrades frozen v1",
  {
    payload <-
      make_sjsdm_tier_payload_fixture(schema_version = "1.0.0")
    ...
    payload_unknown <-
      make_sjsdm_tier_payload_fixture(schema_version = "0.9.0")
