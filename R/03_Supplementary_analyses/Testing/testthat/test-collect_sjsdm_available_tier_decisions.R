...
testthat::test_that(
  "collect_sjsdm_available_tier_decisions() reads a prefix",
  {
...
testthat::test_that(
  "collect_sjsdm_available_tier_decisions() allows no decisions",
  {
    read_meta_function <- function(store_path) {
      NULL
    }
...
testthat::test_that(
  "collect_sjsdm_available_tier_decisions() rejects gaps",
  {
    read_meta_function <- function(store_path) {
      tibble::tibble(
...
testthat::test_that(
  "collect_sjsdm_available_tier_decisions() rejects failed targets",
  {
    read_meta_function <- function(store_path) {
      tibble::tibble(
