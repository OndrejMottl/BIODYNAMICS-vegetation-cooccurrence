testthat::test_that(
  "build_sjsdm_tuning_branch_work_items() preserves real work",
  {
    data_work_items <-
      tibble::tibble(
        work_item_id = "item_1",
...
testthat::test_that(
  "build_sjsdm_tuning_branch_work_items() makes an empty sentinel",
  {
    data_work_items <-
...
testthat::test_that(
  "build_sjsdm_tuning_branch_work_items() validates its schema",
  {
