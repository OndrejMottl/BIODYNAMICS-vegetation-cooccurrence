testthat::test_that(
  "compute_sjsdm_decomposition_fold_effects() preserves raw paired effects",
  {
    data_metrics <-
      tidyr::expand_grid(
        variant = base::c(
...
testthat::test_that(
  "compute_sjsdm_decomposition_fold_effects() exposes unavailable pairs",
  {
    data_metrics <-
      tibble::tibble(
...
testthat::test_that(
  "compute_sjsdm_decomposition_fold_effects() rejects duplicate keys",
  {
    data_metrics <-
      tibble::tibble(
