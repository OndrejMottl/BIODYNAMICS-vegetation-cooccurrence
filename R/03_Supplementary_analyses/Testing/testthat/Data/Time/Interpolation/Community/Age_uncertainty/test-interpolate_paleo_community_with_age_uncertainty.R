...
testthat::test_that(
  "errors when data_age_uncertainty is not a data frame",
  {
    testthat::expect_error(
      interpolate_paleo_community_with_age_uncertainty(
        data_community = data_community_test,
...
testthat::test_that(
  "no uncertainty data matches direct grouped interpolation",
  {
...
testthat::test_that(
  "fossil core value is median across iterations",
  {
    ...
    result <-
      interpolate_paleo_community_with_age_uncertainty(
        data_community = data_simple_core,
...
testthat::test_that(
  "empty age uncertainty matches direct grouped interpolation",
  {
    result_unc <-
      interpolate_paleo_community_with_age_uncertainty(
        data_community = data_community_test,
    ...
    result_direct <-
      interpolate_grouped_time_series(
        data_time_series = data_community_test,
        grouping_variables = base::c("dataset_name", "taxon"),
        time_step = 200,
        age_min = 0,
        age_max = 800
