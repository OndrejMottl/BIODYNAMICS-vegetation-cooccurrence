testthat::test_that("abiotic_variable_name NULL is rejected", {
  testthat::expect_error(
    load_chelsa_raster(
      ...
      x_lim = c(10, 20),
      y_lim = c(45, 55),
      dir_cache = base::tempdir()
    ),
    regexp = "abiotic_variable_name must be a single character string"
  )
})

testthat::test_that("abiotic_variable_name non-character is rejected", {
  testthat::expect_error(
    load_chelsa_raster(
      abiotic_variable_name = 1L,
      age = 1000,
      x_lim = c(10, 20),
      y_lim = c(45, 55),
      dir_cache = base::tempdir()
...
testthat::test_that("abiotic_variable_name length > 1 is rejected", {
  testthat::expect_error(
    load_chelsa_raster(
      abiotic_variable_name = c("bio1", "bio6"),
      age = 1000,
      x_lim = c(10, 20),
      y_lim = c(45, 55),
      dir_cache = base::tempdir()
...
testthat::test_that("dir_cache NULL is rejected", {
  testthat::expect_error(
    load_chelsa_raster(
      abiotic_variable_name = "bio1",
      age = 1000,
    ...
    regexp = "dir_cache must be a string path to an existing directory"
  )
})

testthat::test_that("dir_cache non-character is rejected", {
  testthat::expect_error(
    load_chelsa_raster(
      abiotic_variable_name = "bio1",
      age = 1000,
...
testthat::test_that("dir_cache non-existent path is rejected", {
