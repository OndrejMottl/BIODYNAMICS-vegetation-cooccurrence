testthat::test_that(
  "aggregate_trait_values() validates data argument",
  {
    testthat::expect_error(
      aggregate_trait_values(data_trait_values = "not a data frame")
    )

    testthat::expect_error(
      aggregate_trait_values(data_trait_values = NULL)
    )

    testthat::expect_error(
      aggregate_trait_values(
        data_trait_values = base::matrix(1:6, nrow = 2)
      )
    )
  }
)
...
testthat::test_that(
  "aggregate_trait_values() validates trait_value_column argument",
  {
    data_test <-
      tibble::tibble(
...
testthat::test_that(
  "aggregate_trait_values() validates group_columns argument",
  {
    data_test <-
      tibble::tibble(
        taxon_name = base::c("Genus_A", "Genus_A"),
    ...
    testthat::expect_error(
      aggregate_trait_values(
        data_trait_values = data_test,
        group_columns = base::c("taxon_name", "missing_col")
      )
    )
  }
)
...
testthat::test_that(
  "aggregate_trait_values() validates aggregation_method argument",
  {
    data_test <-
      tibble::tibble(
        taxon_name = base::c("Genus_A", "Genus_A"),
...
testthat::test_that(
  "aggregate_trait_values() returns data frame with right cols",
  {
    ...
    res <-
      aggregate_trait_values(data_trait_values = data_test)
...
testthat::test_that(
  "aggregate_trait_values() computes correct median values",
  {
    ...
    res <-
      aggregate_trait_values(data_trait_values = data_test, aggregation_method = "median")
...
testthat::test_that(
  "aggregate_trait_values() computes correct mean values",
  {
    ...
    res <-
      aggregate_trait_values(data_trait_values = data_test, aggregation_method = "mean")
...
testthat::test_that(
  "aggregate_trait_values() supports partial aggregation_method matching",
  {
    data_test <-
      tibble::tibble(
        taxon_name = base::rep("Genus_A", 3),
    ...
    res_partial <-
      aggregate_trait_values(data_trait_values = data_test, aggregation_method = "med")
