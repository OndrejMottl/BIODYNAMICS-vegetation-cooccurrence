...
testthat::test_that(
  "build_community_taxon_trait_table() errors if data_trait_records not df",
  {
    testthat::expect_error(
      build_community_taxon_trait_table(
        data_trait_records = "not_a_df",
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = data_comm_class_fix
      )
    )
  }
)
...
# --- Input validation: data_trait_taxonomy ---
...
testthat::test_that(
  "build_community_taxon_trait_table() errors if classif table not df",
  {
    testthat::expect_error(
      build_community_taxon_trait_table(
        data_trait_records = data_traits_fix,
        data_trait_taxonomy = base::c("a", "b"),
        data_community_taxonomy = data_comm_class_fix
      )
    )
  }
...
# --- Input validation: data_community_taxonomy ---
  ...
  "build_community_taxon_trait_table() errors if community classif not df",
  {
    testthat::expect_error(
      build_community_taxon_trait_table(
        data_trait_records = data_traits_fix,
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = base::c("a", "b")
      )
    )
  }
)
  ...
  "build_community_taxon_trait_table() errors if community sel_name missing",
  {
    ...
    testthat::expect_error(
      build_community_taxon_trait_table(
        data_trait_records = data_traits_fix,
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = data_bad
      )
    )
  }
)
  ...
  "build_community_taxon_trait_table() returns a tibble",
  {
    res <-
      build_community_taxon_trait_table(
        data_trait_records = data_traits_fix,
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = dplyr::filter(
          data_comm_class_fix,
          sel_name == "Abies"
        ),
        verbose = FALSE
  ...
  "build_community_taxon_trait_table() unmatched taxa absent (no NA row)",
  {
    res <-
      build_community_taxon_trait_table(
        data_trait_records = data_traits_fix,
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = dplyr::bind_rows(
  ...
  "build_community_taxon_trait_table() no matches: 0-row tibble",
  {
    res <-
      build_community_taxon_trait_table(
        data_trait_records = data_traits_fix,
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = data_comm_class_fix_nomatch,
        verbose = FALSE
      )
...
testthat::test_that(
  "build_community_taxon_trait_table() multiple domains as separate cols",
  {
    ...
    res <-
      build_community_taxon_trait_table(
        data_trait_records = data_traits_multi,
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = dplyr::filter(
          data_comm_class_fix,
          sel_name == "Abies"
  ...
  "build_community_taxon_trait_table() suffix taxon resolves via canonical",
  {
    ...
    res <-
      build_community_taxon_trait_table(
        data_trait_records = data_traits_fix,
        data_trait_taxonomy = data_class_fix,
        data_community_taxonomy = data_comm_class_fix_suffix,
        verbose = FALSE
      )
