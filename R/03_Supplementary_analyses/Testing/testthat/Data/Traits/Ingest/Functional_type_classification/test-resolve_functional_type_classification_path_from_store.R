testthat::test_that(
  "resolve_functional_type_classification_path_from_store() picks latest",
  {
    withr::with_tempdir(
      {
        path_grid <-
...
testthat::test_that(
  "resolve_functional_type_classification_path_from_store() uses local",
  {
    withr::with_tempdir(
      {
        path_grid <-
...
testthat::test_that(
  "resolve_functional_type_classification_path_from_store() validates store",
  {
    withr::with_tempdir(
      {
        path_grid <-
...
testthat::test_that(
  "resolve_functional_type_classification_path_from_store() errors on project",
  {
    withr::with_tempdir(
      {
        path_grid <-
...
testthat::test_that(
  "resolve_functional_type_classification_path_from_store() errors on missing",
  {
    withr::with_tempdir(
      {
        path_grid <-
...
testthat::test_that(
  "resolve_functional_type_classification_path_from_store() validates grid",
  {
    withr::with_tempdir(
      {
        path_processed <-
