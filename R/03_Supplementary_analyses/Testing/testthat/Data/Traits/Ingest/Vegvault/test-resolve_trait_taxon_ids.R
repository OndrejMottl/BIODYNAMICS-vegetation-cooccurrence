...
testthat::test_that(
  "resolve_trait_taxon_ids() errors for non-character path",
  {
    testthat::expect_error(
      resolve_trait_taxon_ids(
        data_trait_records = make_clean_traits(),
        path_vegvault = 123
      )
    )
