testthat::test_that(
  "summarise_sjsdm_tuning_timings() reports every cached stage",
  {
    list_cache <-
      base::list(
        base::list(
    ...
    data_timings <-
      summarise_sjsdm_tuning_timings(list_cache)
...
testthat::test_that(
  "summarise_sjsdm_tuning_timings() returns a typed empty table",
  {
    data_timings <-
      summarise_sjsdm_tuning_timings(base::list())
