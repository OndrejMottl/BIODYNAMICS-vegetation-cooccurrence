testthat::test_that(
  "convert_v1_cross_validation_shared_design_artifact() upgrades the frozen v1 fixture",
  {
    vec_payload_names <-
    ...
    testthat::expect_identical(res[["artifact_type"]], "cross_validation_shared_design")
