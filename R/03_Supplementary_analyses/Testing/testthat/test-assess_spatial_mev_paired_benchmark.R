...
testthat::test_that(
  "assess_spatial_mev_paired_benchmark() passes predictive gates",
  {
    res <-
...
testthat::test_that(
  "assess_spatial_mev_paired_benchmark() reports predictive failures",
  {
    data_failed <-
...
testthat::test_that(
  "assess_spatial_mev_paired_benchmark() rejects incomplete pairs",
  {
    data_incomplete <-
      make_spatial_mev_benchmark_fixture() |>
      dplyr::filter(
