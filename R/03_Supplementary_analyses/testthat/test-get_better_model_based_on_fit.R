...
testthat::test_that(
  desc = "return correct class - TjurR2",
  code = {
    result <-
...
testthat::test_that(
  desc = "return correct data - TjurR2",
  code = {
    result <-
      get_better_model_based_on_fit(
        list_models = list(
...
testthat::test_that(
  desc = "return correct class - WAIC",
  code = {
    result <-
      get_better_model_based_on_fit(
        list_models = list(
...
testthat::test_that(
  ...
  code = {
    ...
    testthat::expect_identical(
      result,
      example_eval_null # the difference in WAIC is less than 2
    )
  }
)
