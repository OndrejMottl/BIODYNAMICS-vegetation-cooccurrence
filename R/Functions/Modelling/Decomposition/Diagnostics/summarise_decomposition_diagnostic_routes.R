...
#' metrics produced by `run_decomposition_diagnostic_folds()`.
...
#' @export
summarise_decomposition_diagnostic_routes <- function(
  ...
  data_fold_status <-
    ...
    purrr::map(
      .f = ~ {
        ...
        full_loss <-
          .resolve_decomposition_fold_loss(
            data_fold = data_fold,
            variant_name = "full"
          )
        ...
        no_spatial_loss <-
          .resolve_decomposition_fold_loss(
            data_fold = data_fold,
            variant_name = "no_spatial"
          )

        no_associations_loss <-
          .resolve_decomposition_fold_loss(
            data_fold = data_fold,
            variant_name = "no_associations"
          )
