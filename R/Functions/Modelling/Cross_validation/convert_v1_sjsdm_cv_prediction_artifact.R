#' @title Convert a v1 sjsdm cv predictions Artifact
#' @description
#' Applies the frozen v1 fixture contract and upgrades an assembled payload to
#' the canonical `sjsdm_cv_predictions` v2 envelope.
...
#' @export
convert_v1_sjsdm_cv_prediction_artifact <- function(
    payload = NULL,
    pipeline_id = NULL,
  ...
  res <-
    convert_sjsdm_v1_artifact(
      ...
      migration_function = "convert_v1_sjsdm_cv_prediction_artifact",
