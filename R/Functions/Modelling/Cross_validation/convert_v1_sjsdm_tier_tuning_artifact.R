#' @title Convert a v1 sjsdm tier tuning Artifact
#' @description
#' Applies the frozen v1 fixture contract and upgrades an assembled payload to
#' the canonical `sjsdm_tier_tuning` v2 envelope.
...
#' @export
convert_v1_sjsdm_tier_tuning_artifact <- function(
    payload = NULL,
    pipeline_id = NULL,
  ...
  res <-
    convert_sjsdm_v1_artifact(
      ...
      migration_function = "convert_v1_sjsdm_tier_tuning_artifact",
