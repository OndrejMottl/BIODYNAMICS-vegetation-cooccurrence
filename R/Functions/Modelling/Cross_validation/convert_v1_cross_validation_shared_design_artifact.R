#' @title Convert a v1 cross validation shared design Artifact
#' @description
...
#' @export
convert_v1_cross_validation_shared_design_artifact <- function(
    payload = NULL,
    pipeline_id = NULL,
  ...
  res <-
    convert_sjsdm_v1_artifact(
      ...
      migration_function = "convert_v1_cross_validation_shared_design_artifact",
