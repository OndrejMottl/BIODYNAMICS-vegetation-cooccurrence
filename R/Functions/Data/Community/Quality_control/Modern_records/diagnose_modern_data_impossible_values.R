#' @title Diagnose Modern Data Impossible Values
#' @description
#' Returns modern community and coordinate values that are impossible before
#' modelling.
...
#' @export
diagnose_modern_data_impossible_values <- function(
    data_community = NULL,
