...
#' )
#' @seealso
#' resolve_scale_id_from_store, resolve_continent_ids_from_scale_ids,
#' load_latest_functional_type_classification
#' @export
resolve_functional_type_classification_path_from_store <- function(
  ...
  assertthat::assert_that(
    ...
    msg = stringr::str_glue(
      ...
      "store). Got NULL from resolve_scale_id_from_store(). ",
